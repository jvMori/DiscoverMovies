package com.mori.jvmori.discovermovies.data.network

import com.mori.jvmori.discovermovies.data.local.entity.DiscoverMovieResponse
import com.mori.jvmori.discovermovies.data.network.response.credits.CreditsResponse
import com.mori.jvmori.discovermovies.data.network.response.genre.GenreResponse
import com.mori.jvmori.discovermovies.data.network.response.movie.MovieDetails
import com.mori.jvmori.discovermovies.data.network.response.recommendations.RecommendationsResponse
import com.mori.jvmori.discovermovies.data.network.response.search.SearchResponse
