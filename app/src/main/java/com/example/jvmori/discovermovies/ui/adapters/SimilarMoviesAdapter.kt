...
class SimilarMoviesAdapter : BaseAdapter<MovieResult>() {
    ...
    override var iOnItemClickListener: IOnItemClickListener? = null
    ...
    class MovieViewHolder(itemView: View, private var iOnItemClickListener: IOnItemClickListener?) : BaseViewHolder<MovieResult>(itemView){
        override fun bindView(item : MovieResult){
            ...
            itemView.setOnClickListener{
                iOnItemClickListener?.onItemClicked(item.id)
            }
        }
    }
}